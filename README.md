...
- 프레임워크는 Nest.JS, 언어는 Typescript를 사용합니다.
  - express로 먼저 구현해본 후, nest로 이식했습니다.
- ORM 사용 가능합니다. (TypeORM, Sequelize)

### 진행 기록
- express.js를 이용하여,
  https://bingle625.notion.site/node-js-trial-43eb76dc2f9e4a39a2e0e849cf800937
- nest.js를 이용하여,
  https://bingle625.notion.site/typescript-trial-c820979208ac4ae89edee84819379669
